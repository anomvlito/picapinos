    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="max-w-2xl">
          ...
          <p
            className="text-base leading-relaxed opacity-60 mb-10 max-w-md"
            style={{ fontFamily: 'var(--font-neue-montreal)', color: '#F5F2ED' }}
          >
            Consultanos por WhatsApp. Sin compromiso, te respondemos rápido con información, presupuestos y plazos.
          </p>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <a
              ...
              className="text-sm tracking-wider uppercase px-8 py-4 transition-opacity hover:opacity-80 inline-flex items-center gap-3"
              style={{
